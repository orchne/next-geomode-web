...
const Mission = () => {
  return (
    ...
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-3xl font-bold capitalize lg:text-4xl text-white text-right">Our Main <br/> <span className="text-[#2ee09a]">Missions</span></h1>
        ...
        <div class="hidden lg:flex lg:w-1/2 lg:justify-center">
            ...
            <div class="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                <div class="space-y-3">
                    ...
                    <h1 class="text-2xl font-semibold text-white capitalize ">New Components</h1>
                ...
                <div class="space-y-3">
                    ...
                    <h1 class="text-2xl font-semibold text-white capitalize">elegant Dark Mode</h1>
                ...
                <div class="space-y-3">
                    ...
                    <h1 class="text-2xl font-semibold text-white capitalize">Easy to customiztions</h1>
                ...
                <div class="space-y-3">
                    ...
                    <h1 class="text-2xl font-semibold text-white capitalize">Simple & clean designs</h1>
