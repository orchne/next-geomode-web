...
const index = () => {
  return (
    <section class="min-h-screen bg-[#202340] lg:flex">
    <div class="flex flex-col justify-center w-full p-8 lg:bg-gray-100 lg:dark:bg-gray-800 lg:px-12 xl:px-32 lg:w-1/2 bg-gradient-to-r from-[#020024] via-[#794488] to-[#5500ff]">
        <div className='mb-8'>
            <h1 class="text-3xl font-semibold  capitalize text-white lg:text-4xl"><span className='text-[#2ee09a]'>Get in touch </span> with us!</h1>
        ...
        <div className=''>
            <h2 class="text-xl font-semibold text-white lg:text-2xl">Our <span className='text-[#2ee09a]'>Address</span></h2>
            <p class="mt-4 text-white">
                Ask us everything and we would love
                to hear from you
            </p>
        ...
        <div class="mt-6 md:mt-8">
            <h3 class="font-medium text-white">Follow us</h3>
        ...
        <form>
            <div class="-mx-2 md:items-center md:flex">
                <div class="flex-1 px-2">
                    <label class="block mb-2 text-sm text-white">Full Name</label>
